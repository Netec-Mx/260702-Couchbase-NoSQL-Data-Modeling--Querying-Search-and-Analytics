...
subtitle: "Modelado, consulta, búsqueda y análisis de datos NoSQL con Couchbase" # COLOCAR EL NOMBRE REAL DEL CURSO
emoji: "✨" 
intro: |
  Bienvenido a la **Plataforma de Laboratorios** del curso **Modelado, consulta, búsqueda y análisis de datos NoSQL con Couchbase**. Aquí podrás explorar diferentes configuraciones a través de prácticas guiadas. ¡Desarrolla tus habilidades y lleva tus conocimientos al siguiente nivel!
course_id: cd212 # COLOCAR EL NOMBRE DEL CURSO, ES EL NOMBRE DEL ARCHIVO MISMO Y NOMBRE DEFINIDO EN _data/courses.yaml
permalink: / 
